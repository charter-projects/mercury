...
final DartGetMercuryInfo _getMercuryInfo = MercuryDynamicLibrary.ref
    .lookup<NativeFunction<NativeGetMercuryInfo>>('getMercuryInfo')
    .asFunction();
...
dynamic invokeModuleEvent(
  ...
  Pointer<NativeValue> dispatchResult = _invokeModuleEvent(
      _allocatedMercuryIsolates[contextId]!,
      nativeModuleName,
...
final DartCreateScreen _createScreen = MercuryDynamicLibrary.ref
...
typedef NativeParseHTML = Void Function(
    Pointer<Void>, Pointer<Utf8> code, Int32 length);
typedef DartParseHTML = void Function(
    Pointer<Void>, Pointer<Utf8> code, int length);

final DartEvaluateScripts _evaluateScripts = MercuryDynamicLibrary.ref
    .lookup<NativeFunction<NativeEvaluateScripts>>('evaluateScripts')
    .asFunction();

final DartParseHTML _parseHTML = MercuryDynamicLibrary.ref
...
Future<bool> evaluateScripts(int contextId, String code,
    {String? url, int line = 0}) async {
  if (MercuryController.getControllerOfJSContextId(contextId) == null) {
    return false;
  }
  ...
  QuickJSByteCodeCacheObject cacheObject =
      await QuickJSByteCodeCache.getCacheObject(code);
    ...
    try {
      ...
      if (QuickJSByteCodeCache.isCodeNeedCache(code)) {
        ...
        Pointer<Pointer<Uint8>> bytecodes =
            malloc.allocate(sizeOf<Pointer<Uint8>>());
        Pointer<Uint64> bytecodeLen = malloc.allocate(sizeOf<Uint64>());
        result = _evaluateScripts(_allocatedMercuryIsolates[contextId]!,
            nativeString, bytecodes, bytecodeLen, _url, line);
        Uint8List bytes = bytecodes.value.asTypedList(bytecodeLen.value);
        // Save to disk cache
        QuickJSByteCodeCache.putObject(code, bytes);
      } else {
        result = _evaluateScripts(_allocatedMercuryIsolates[contextId]!,
            nativeString, nullptr, nullptr, _url, line);
      }
      return result == 1;
    } catch (e, stack) {
      print('$e\n$stack');
...
typedef NativeEvaluateQuickjsByteCode = Int8 Function(
    Pointer<Void>, Pointer<Uint8> bytes, Int32 byteLen);
typedef DartEvaluateQuickjsByteCode = int Function(
    Pointer<Void>, Pointer<Uint8> bytes, int byteLen);

final DartEvaluateQuickjsByteCode _evaluateQuickjsByteCode =
    MercuryDynamicLibrary.ref
...
bool evaluateQuickjsByteCode(int contextId, Uint8List bytes) {
  ...
  assert(_allocatedMercuryIsolates.containsKey(contextId));
  int result = _evaluateQuickjsByteCode(
      _allocatedMercuryIsolates[contextId]!, byteData, bytes.length);
...
void parseHTML(int contextId, String code) {
  ...
  try {
    assert(_allocatedMercuryIsolates.containsKey(contextId));
    _parseHTML(
        _allocatedMercuryIsolates[contextId]!, nativeCode, nativeCode.length);
  } catch (e, stack) {
    print('$e\n$stack');
  }
...
typedef NativeInitDartIsolateContext = Pointer<Void> Function(
    Pointer<Uint64> dartMethods, Int32 methodsLength);
typedef DartInitDartIsolateContext = Pointer<Void> Function(
    Pointer<Uint64> dartMethods, int methodsLength);

final DartInitDartIsolateContext _initDartIsolateContext = MercuryDynamicLibrary
    .ref
    .lookup<NativeFunction<NativeInitDartIsolateContext>>(
        'initDartIsolateContext')
    .asFunction();

Pointer<Void> initDartIsolateContext(List<int> dartMethods) {
  Pointer<Uint64> bytes =
      malloc.allocate<Uint64>(sizeOf<Uint64>() * dartMethods.length);
...
typedef NativeDisposeMercuryIsolate = Void Function(
    Pointer<Void>, Pointer<Void> mercuryIsolate);
typedef DartDisposeMercuryIsolate = void Function(
    Pointer<Void>, Pointer<Void> mercuryIsolate);

final DartDisposeMercuryIsolate _disposeMercuryIsolate = MercuryDynamicLibrary
    .ref
    .lookup<NativeFunction<NativeDisposeMercuryIsolate>>(
        'disposeMercuryIsolate')
    .asFunction();
...
final DartNewMercuryIsolateId _newMercuryIsolateId = MercuryDynamicLibrary.ref
    .lookup<NativeFunction<NativeNewMercuryIsolateId>>('newMercuryIsolateId')
    .asFunction();
...
typedef NativeAllocateNewMercuryIsolate = Pointer<Void> Function(
    Pointer<Void>, Int32);
typedef DartAllocateNewMercuryIsolate = Pointer<Void> Function(
    Pointer<Void>, int);

final DartAllocateNewMercuryIsolate _allocateNewMercuryIsolate =
    MercuryDynamicLibrary.ref
        .lookup<NativeFunction<NativeAllocateNewMercuryIsolate>>(
            'allocateNewMercuryIsolate')
        .asFunction();

void allocateNewMercuryIsolate(int targetContextId) {
  Pointer<Void> mercuryIsolate =
      _allocateNewMercuryIsolate(dartContext.pointer, targetContextId);
...
final DartInitDartDynamicLinking _initDartDynamicLinking = MercuryDynamicLibrary
    .ref
    .lookup<NativeFunction<NativeInitDartDynamicLinking>>(
        'init_dart_dynamic_linking')
    .asFunction();
...
typedef NativeRegisterDartContextFinalizer = Void Function(
    Handle object, Pointer<Void> dart_context);
typedef DartRegisterDartContextFinalizer = void Function(
    Object object, Pointer<Void> dart_context);

final DartRegisterDartContextFinalizer _registerDartContextFinalizer =
    MercuryDynamicLibrary.ref
        .lookup<NativeFunction<NativeRegisterDartContextFinalizer>>(
            'register_dart_context_finalizer')
        .asFunction();
...
final DartRegisterPluginByteCode _registerPluginByteCode = MercuryDynamicLibrary
    .ref
...
final bool isEnabledLog =
    !kReleaseMode && Platform.environment['ENABLE_MERCURYJS_LOG'] == 'true';

typedef NativeDispatchIsolateTask = Void Function(
    Int32 contextId, Pointer<Void> context, Pointer<Void> callback);
typedef DartDispatchIsolateTask = void Function(
    int contextId, Pointer<Void> context, Pointer<Void> callback);

void dispatchIsolateTask(
    int contextId, Pointer<Void> context, Pointer<Void> callback) {
...
base class IsolateCommandItem extends Struct {
  @Int64()
  external int type;
...
final DartGetIsolateCommandItems _getIsolateCommandItems = MercuryDynamicLibrary
    .ref
    .lookup<NativeFunction<NativeGetIsolateCommandItems>>(
        'getIsolateCommandItems')
    .asFunction();
...
final DartGetIsolateCommandItemSize _getIsolateCommandItemSize =
    MercuryDynamicLibrary.ref
        .lookup<NativeFunction<NativeGetIsolateCommandItemSize>>(
            'getIsolateCommandItemSize')
        .asFunction();
...
final DartClearIsolateCommandItems _clearIsolateCommandItems =
    MercuryDynamicLibrary
        .ref
        .lookup<NativeFunction<NativeClearIsolateCommandItems>>(
            'clearIsolateCommandItems')
        .asFunction();
...
List<IsolateCommand> readNativeIsolateCommandToDart(
  ...
  List<IsolateCommand> results = List.generate(commandLength, (int _i) {
    ...
    command.nativePtr2 =
        nativePtr2Value != 0 ? Pointer.fromAddress(nativePtr2Value) : nullptr;
...
void flushIsolateCommand(MercuryContextController context) {
  ...
  Pointer<Uint64> nativeCommandItems =
      _getIsolateCommandItems(_allocatedMercuryIsolates[context.contextId]!);
  int commandLength =
      _getIsolateCommandItemSize(_allocatedMercuryIsolates[context.contextId]!);

  if (commandLength == 0 || nativeCommandItems == nullptr) {
    return;
  }

  List<IsolateCommand> commands = readNativeIsolateCommandToDart(
      nativeCommandItems, commandLength, context.contextId);
    ...
    try {
      switch (commandType) {
        ...
        case IsolateCommandType.createEventTarget:
          context.createEventTarget(
              context, command.args, nativePtr.cast<NativeBindingObject>());
          break;
        case IsolateCommandType.disposeBindingObject:
          context.disposeBindingObject(
              context, nativePtr.cast<NativeBindingObject>());
          break;
        case IsolateCommandType.addEvent:
          Pointer<AddEventListenerOptions> eventListenerOptions =
              command.nativePtr2.cast<AddEventListenerOptions>();
        ...
        case IsolateCommandType.removeEvent:
          ...
          context.removeEvent(
              nativePtr.cast<NativeBindingObject>(), command.args,
              isCapture: isCapture);
          break;
        default:
          break;
